/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 37571b837721b9ec6554a4e09717e8ca)
// Runtime types generated with workerd@1.20260804.1 2026-01-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	APP_URL: "https://preview.trenodo.com" | "https://trenodo.com";
	ADMIN_EMAIL: "gm@gmco.dk";
	BETTER_AUTH_SECRET: string;
	STUDENT_SESSION_SECRET: string;
	RESEND_API_KEY: string;
	WORKER_SELF_REFERENCE: Fetcher /* hedwig-preview */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		APP_URL: "https://preview.trenodo.com";
		ADMIN_EMAIL: "gm@gmco.dk";
		BETTER_AUTH_SECRET: string;
		STUDENT_SESSION_SECRET: string;
		WORKER_SELF_REFERENCE: Fetcher /* hedwig-preview */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "ADMIN_EMAIL" | "BETTER_AUTH_SECRET" | "STUDENT_SESSION_SECRET" | "RESEND_API_KEY">> {}
}
